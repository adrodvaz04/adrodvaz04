...
1. [NUSci Web Development Team 🌐](https://github.com/Northeastern-Science-Magazine): Worked as a junior developer, the tech stack for backend includes MongoDB, Node.js, RESTful APIs, Jest unit testing, and JavaScript.

2. [Scout Studio w/ SuperPower Mentors](https://github.com/Scout-NU/Superpower-Mentors): Junior Developer, working on creating an overhauled website MVP in React/Typescript.
